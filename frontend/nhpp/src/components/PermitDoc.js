...
function PermitDoc(props) {
    ...
    return (
      ...
      <div>
        ...
        <p style={{margin: '0in', fontSize: '16px', fontFamily: '"Times New Roman",serif', marginLeft: '.25in', textIndent: '-.25in'}}><span style={{fontSize: '13px', fontFamily: '"Arial",sans-serif'}}>&nbsp;</span></p>
        <p style={{margin: '0in', fontSize: '16px', fontFamily: '"Times New Roman",serif', marginLeft: '.25in', textIndent: '-.25in'}}><span style={{fontSize: '13px', fontFamily: '"Arial",sans-serif'}}>11.&nbsp;</span><span style={{fontSize: '13px', fontFamily: '"Arial",sans-serif'}}>The Radiation Safety Officer for this permit is</span><span style={{fontSize: '13px', fontFamily: '"Arial",sans-serif'}}>&nbsp;{props.permitInfo.primary_rso.first_name}. A written continuity plan for a qualified Radiation Safety Officer shall be kept current and be approved, annually, by the Radiation Safety Committee. If the Radiation Safety Officer permanently discontinues duties under this permit, the permittee shall immediately notify the National Health Physics Program. Permit activities must cease without a qualified Radiation Safety Officer who meets Nuclear Regulatory Commission requirements.</span></p>
        <p style={{margin: '0in', fontSize: '16px', fontFamily: '"Times New Roman",serif', marginLeft: '.25in', textIndent: '-.25in'}}><span style={{fontSize: '13px', fontFamily: '"Arial",sans-serif'}}>&nbsp;</span></p>
